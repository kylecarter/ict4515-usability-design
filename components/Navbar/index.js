...
class Navbar extends React.Component {
    ...
    render() {
        const { authenticated, classes, show } = this.state;
        return (<AppBar position="fixed" color="inherit" className={classes.bar}>
            <Toolbar className={classes.tools}>
                ...
                {!authenticated && <IconButton className={classes.menu} onClick={this.expose} onTouchEnd={this.expose}>
                    <MenuIcon className={classes.svg} />
                </IconButton>}
                {!authenticated && <div className={[styles.buttons, classes.buttons, show ? styles.expose : ''].join(' ')}>
                ...
                {authenticated && <IconButton href="/notes" title="My Notes" component={Anchor}>
